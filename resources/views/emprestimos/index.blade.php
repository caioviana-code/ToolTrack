    ...
    <table class="table align-middle caption-top table-striped">
        ...
        <tbody>
            ...
            <tr class="row-filtro">
                ...
                <td data-coluna="dataEmprestimo">{{ $item->dataEmprestimo }}</td>
                <td data-coluna="dataDevolucao">
                ...
                <td>
                    @if($item->dataDevolucao === null)
                    <a href="{{ route('emprestimos.edit', $item->id) }}" class="btn">
                    ...
                    <a nohref style="cursor:pointer" onclick="showInfoModal(
                        ...
                        'DATA EMPRÉSTIMO: {{ $item->dataEmprestimo }}',
                        'DATA DEVOLUÇÃO PREVISTA: {{ $item->dataDevolucaoPrevista }}',
                    ...
                    @if($item->dataDevolucao === null)
                    <a nohref style="cursor:pointer" onclick="showRemoveModal('{{ $item['id'] }}', '{{ $item['id'] }}')" class="btn">
                ...
                <form action="{{ route('emprestimos.destroy', $item['id']) }}" method="POST" id="form_{{$item['id']}}">
                    @csrf
                    @method('DELETE')
                </form>
            </tr>
