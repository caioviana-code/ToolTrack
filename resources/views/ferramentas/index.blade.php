        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        <a href= "{{ route('ferramentas.edit', $item->id) }}" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('NOME: {{ $item->nome }}', 'ESTOQUE: {{ $item->estoque }}')" class="btn btn-primary">
