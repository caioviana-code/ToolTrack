...
<head>
    ...
    <title>ToolTrack - @yield('titulo')</title>
...
<body>
    <nav class="navbar sticky-top navbar-expand-md navbar-dark" style="background-color: #247BA0;">
        <div class="container-fluid">
            <a href="dashboard" class="navbar-brand ms-sm-3">
                <span class="ms-3 fs-5" style="font-weight: bold;">ToolTrack</span>
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{route('reservas.index')}}" class="dropdown-item">Reservas</a></li>
                        </ul>
                    </li>
    ...
    <nav class="navbar fixed-bottom navbar-dark" style="background-color: #247BA0;">
        <div class="container-fluid">
